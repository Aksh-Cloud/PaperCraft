...
function preloadSounds() {
    ...
    const allSounds = [...Object.values(Sounds).flat(), ...extraSounds];
    allSounds.forEach((sound) => {
        const url = sound.endsWith(".ogg")
            ? `${AUDIO_BASE_URL}${sound}`
            : `${AUDIO_BASE_URL}${sound}.ogg`;
        if (!soundCache[url]) {
